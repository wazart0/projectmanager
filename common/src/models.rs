...
pub const RESOURCE_COLUMNS: [&str; 13] = ["resource_id", "name", "resource_type_id", "description", "comment", "cost", "cost_currency", "billing_frequency", "billing_interval", "availability", "capacity", "capacity_unit", "is_active"];
